<template>
  ...
  import { ref, defineEmits, onMounted, defineProps, toRefs } from 'vue';
  ...
  let incomename = ref(spending_name.value);
  let Iamount = ref(amount.value);
  ...
  async function addIncome() {
    ...
    let currentAmount = parseFloat(Iamount.value);
