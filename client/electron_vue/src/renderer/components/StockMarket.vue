...
<template>
    <header class="flex-none flex h-16  px-4 items-center">
...
<header class="flex-none flex px-4 items-center">
   ...
   <a href="#" :class="{ 'inline-block rounded-full text-indigo-700 bg-indigo-100 text-xs font-bold mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1': activeButton === 'hot', 'inline-block rounded-full text-black text-xs mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1': activeButton !== 'hot' }" @click="setActiveButton('hot')" >
                         Hot
                      </a>
       <a href="#" :class="{ 'inline-block rounded-full text-indigo-700 bg-indigo-100 text-xs font-bold mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1': activeButton === 'upside', 'inline-block rounded-full text-black text-xs mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1': activeButton !== 'upside' }"
       @click="filterUpTrendStock()
                          ">
                          Upside
                      </a>
       <a href="#"  :class="{ 'inline-block rounded-full text-indigo-700 bg-indigo-100 text-xs font-bold mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1': activeButton === 'downside', 'inline-block rounded-full text-black text-xs mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1': activeButton !== 'downside' }" @click="filterDownTrendStock()">
                          Downside
                      </a>
  </header>
  ...
  <div class="select-none cursor-pointer  bg-indigo-100 rounded-md flex flex-1 items-center p-3 transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow">
